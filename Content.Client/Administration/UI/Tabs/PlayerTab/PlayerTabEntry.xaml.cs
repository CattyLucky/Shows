...
public sealed partial class PlayerTabEntry : PanelContainer
{
    ...
    public event Action<NetUserId, int>? OnBankBalanceSaved;
        ...
        AdminPlayerTabSymbolOption symbolSetting)
    {
        ...
        BankBalanceSpinBox.OverrideValue(player.BankBalance ?? 0);
        BankBalanceSpinBox.LineEditDisabled = !player.Connected || player.BankBalance == null;
        BankBalanceSpinBox.SetButtonDisabled(!player.Connected || player.BankBalance == null);
        BankBalanceSaveButton.Disabled = !player.Connected || player.BankBalance == null;
        BankBalanceSaveButton.OnPressed += _ => OnBankBalanceSaved?.Invoke(player.SessionId, BankBalanceSpinBox.Value);
    }
}
