...
{
    private static readonly Color FinanceText = Color.FromHex("#D6C79B");
    private static readonly Color FinanceBalanceText = Color.FromHex("#B9D7C3");
    private static readonly Color FinanceWarningText = Color.FromHex("#D98F88");
    ...
    private void UpdateLoadoutFinance(RoleLoadout loadout, IDependencyCollection collection)
    {
        ...
        Cost.FontColorOverride = cost <= Profile.BankBalance ? FinanceText : FinanceWarningText;
        Balance.FontColorOverride = cost <= Profile.BankBalance ? FinanceBalanceText : FinanceWarningText;
    }
}
