...
public sealed partial class JobReassignmentInjectorSystem : EntitySystem
{
    ...
    private void OnDoAfter(EntityUid uid, JobReassignmentInjectorComponent component, ref JobReassignmentInjectorDoAfterEvent args)
    {
        ...
        if (!_reassignment.TryApplyToEntity(target, jobId, actor: args.User, extraImplants: bodyImplants, ignoreDemographicRequirements: component.IgnoreDemographicRequirements))
        {
