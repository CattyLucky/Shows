...
[UsedImplicitly]
public sealed partial class JobPresetIdCardConsoleSystem : SharedJobPresetIdCardConsoleSystem
{
        ...
        JobPresetIdCardConsoleComponent? component = null)
    {
        ...
        {
            QueueDel(injector);
            JobPresetSawmill.Error($"Spawned injector '{InjectorPrototypeId}' without a {nameof(JobReassignmentInjectorComponent)}.");
            return;
        }
        ...
        out JobReassignmentData data)
    {
        ...
        {
            JobPresetSawmill.Warning($"Tried to apply job preset '{jobPrototype}' that is not present on the console.");
            return false;
        }

        if (!_reassignment.TryResolveJobData(jobPrototype, out data))
        {
            JobPresetSawmill.Warning($"Invalid job preset '{jobPrototype}' on preset ID card console.");
            return false;
        }
