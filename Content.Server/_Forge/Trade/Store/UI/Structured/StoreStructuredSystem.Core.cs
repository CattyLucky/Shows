...
public sealed partial class StoreStructuredSystem : EntitySystem
{
    ...
    [Dependency] private StoreSystemStructuredLoader _loader = default!;
    ...
    [Dependency] private NcStoreSystem _storeSystem = default!;
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RefillableSolutionComponent, SolutionChangedEvent>(OnRefillableSolutionChanged);
