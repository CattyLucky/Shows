...
public sealed partial class NcContractSystem : EntitySystem
{
    ...
    private bool TryValidateArtifactStudyArtifact(string contractId, string artifactPrototype)
    {
        ...
        if (proto.HasComponent<XenoArtifactComponent>(_compFactory))
            return true;

        Sawmill.Warning(
            $"[Contracts] Artifact-study contract '{contractId}' artifact '{artifactPrototype}' must be a direct xeno artifact entity, not a random spawner.");
        return false;
    }
