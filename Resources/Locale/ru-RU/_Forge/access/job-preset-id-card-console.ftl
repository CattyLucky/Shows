...
ent-ForgeJobReassignmentConsole = консоль переназначения профессии
desc-ForgeJobReassignmentConsole = Выдаёт выбранную профессию на целевую ID-карту или создаёт инжектор переназначения.
ent-ForgeJobReassignmentComputerCircuitboard = плата консоли переназначения профессии
desc-ForgeJobReassignmentComputerCircuitboard = Компьютерная плата для консоли переназначения профессии.
